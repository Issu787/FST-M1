...
with webbrowser.Firefox() as browser:
    ...
    user_field = browser.find_element(By.XPATH,"//input[@name='username']")
    pass_field = browser.find_element(By.XPATH,"//input[@name = 'password']")
    ...
    print(f"Post-login page title: {browser.title}")
